...
class Window(QDialog):
	...
	def home(self):
		...
		btn.move(0, 0)
		btn.clicked.connect(convert2CramList)
...
def exportDeckToFile():
	...
	return notes
def wrapIntoHalfLines(textFile):
	rows = []
...
def saveStringToFile(fileName,string_to_save):
	with io.open(fileName, "w") as readFile:
		readFile.write(string_to_save)

def convert2CramList():
